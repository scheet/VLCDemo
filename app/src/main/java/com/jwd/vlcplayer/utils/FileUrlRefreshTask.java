...
public class FileUrlRefreshTask extends AsyncTask<Void, Void, String> {
    private String TAG = "FileUrlRefreshTask";
...
//    private String type;
    ...
    public FileUrlRefreshTask(String openid, String typeRequest, Handler mHandler) {
        super();
        this.openid = openid;
...
//        HttpGet httpGet = new HttpGet("http://192.168.1.61:8000/video/" + "?" + urlParam);
        HttpGet httpGet = new HttpGet("http://192.168.1.61:8000/video/refresh/" + "?" + urlParam);
        Log.e(TAG, "获取图片URL的结果：" + "http://192.168.1.61:8000/video/refresh/" + "?" + urlParam);
