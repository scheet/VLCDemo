...
//            Log.e(TAG,"mMediaPlayer.getLength() = " + mMediaPlayer.getLength());
    ...
    public long getCurrentPosition() {
        if (isPrepare() && canInfo) {
//            Log.e(TAG, "getCurrentPosition mMediaPlayer.getDuration = " + getDuration());
//            Log.e(TAG, "getCurrentPosition mMediaPlayer.getPosition() = " + mMediaPlayer.getPosition());
