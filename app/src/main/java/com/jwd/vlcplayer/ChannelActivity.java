...
import com.jwd.vlcplayer.adapter.DragAdapter;
import com.jwd.vlcplayer.adapter.OtherAdapter;
import com.jwd.vlcplayer.app.AppApplication;
import com.jwd.vlcplayer.base.BaseActivity;
import com.jwd.vlcplayer.bean.ChannelItem;
import com.jwd.vlcplayer.bean.ChannelManage;
import com.jwd.vlcplayer.view.DragGrid;
import com.jwd.vlcplayer.view.OtherGridView;
...
public class ChannelActivity extends BaseActivity implements OnItemClickListener {
	...
	public void onBackPressed() {
		...
		if(userAdapter.isListChanged()){
			Intent intent = new Intent(ChannelActivity.this, LaunchActivity.class);
			intent.putExtra("isChange","true");
//			setResult(LaunchActivity.CHANNELRESULT, intent);
